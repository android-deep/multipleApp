...
public class CommonUtil {
    ...
    public static void install64Bit() {
        Schedulers.io().scheduleDirect(() -> {
            ...
            try {
                ...
                File file = new File(VApp.getApp().getFilesDir(), "app64.pak");
    ...
    public static boolean isHuawei() {
        return StatUtils.getChannel(VApp.getApp()).equals("huawei");
    }
    ...
    private static int[] iconArray = new int[]{R.drawable.icon_fake_bag, R.drawable.icon_fake_calculator, R.drawable.icon_fake_calendar, R.drawable.icon_fake_chart,
                R.drawable.icon_fake_clipboard, R.drawable.icon_fake_clock, R.drawable.icon_fake_google_wallet, R.drawable.icon_fake_locker, R.drawable.icon_fake_shop,
                R.drawable.icon_fake_solo, R.drawable.icon_fake_square, R.drawable.icon_fake_truck, R.drawable.icon_fake_zoom};

    public static int[] getFakeIcons() {
        return iconArray;
    }

    public static Drawable loadFakeIconDrawable(String src) {
        ...
        try {
            if (src.length() < 3) {
                ...
                return VApp.getApp().getResources().getDrawable(iconArray[i]);
            }else{
                return Drawable.createFromPath(src);
            }
        }catch (Exception e){
            return null;
        }
    ...
    public static String getAppFakeName(AppData appData){
        FakeAppInfo fakeAppInfo = appData.getFakeAppInfo();
        String targetName;
        if (fakeAppInfo==null||TextUtils.isEmpty(fakeAppInfo.getFakeName())){
            targetName = appData.getName();
        }else{
            targetName = fakeAppInfo.getFakeName();
        }
        return targetName;
    }

    public static Drawable getAppFakeIcon(AppData appData){
        FakeAppInfo fakeAppInfo = appData.getFakeAppInfo();
        Drawable targetIcon;
        if (fakeAppInfo==null||TextUtils.isEmpty(fakeAppInfo.getFakeIcon())||fakeAppInfo.getFakeIcon().equals("-1")){
            targetIcon = appData.getIcon();
        }else{
            targetIcon = loadFakeIconDrawable(fakeAppInfo.getFakeIcon());
        }
        return targetIcon;
    }
